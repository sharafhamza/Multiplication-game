            ...
            if(playerthreeinput.value <=108 && playerthreeinput.value >=1){
                ...
                if(count3 != 0){
                    if(playeronenumber == playerthreeinput.value){                        
                        playerfourvalue = success3.innerHTML = `Congratulations!</br> Player 3 and Player ${finalvalue} winner`;
                    ...
                    if(finalvalue == 1){
                        playerfourvalue = success3.innerHTML = `Congratulations!</br> Player 1 winner`;
                    }
                    else{
                        playerfourvalue = success3.innerHTML = `Congratulations!</br> Player 1 and Player ${finalvalue} winner `;
                    }
                    area3.style.display = "none";
                    playerthree.style.paddingBottom = "20px";
                    playerthreebutton.style.display = "none";
            ...
            if(playerfourinput.value <=108 && playerfourinput.value >=1){
                ...
                if(count4 !=0){
                    if(playeronenumber == playerfourinput.value){
                        ...
                        success4.innerHTML = `${playerfourvalue} and Player 4 winner</br> The muliplication was </br> ${playeroneinput.value} x 9 = ` + playeronenumber;
                        ...
                        window.addEventListener("mousemove", function(e){
                           ...
                           box3.style.transform = `translate(${e.clientX / 5}px, ${e.clientY / 5}px)`
                        })
                        const start = () => {
                            setTimeout(function() {
                                confetti.start()
                    ...
                    if(result){
                        success4.innerHTML = `${playerfourvalue} </br> The muliplication was </br> ${playeroneinput.value} x 9 = ` + playeronenumber;                    
                    }
                    else{
                        success4.innerHTML = `${playerfourvalue} </br> and Player 1 winner </br> The muliplication was </br> ${playeroneinput.value} x 9 = ` + playeronenumber;                    
                    }
                    box2.style.display = "none";
                    playerfourbutton.style.display = "none";
                    playerfourinput.style.display = "none";
